...
const I18N = {
  ...
  zh: {
    ui: {
      ...
      trayScreensaverPowerHint: '提示：Windows 关屏/睡眠时间须晚于所选等待时间，否则可能看不到演出。',
  ...
  en: {
    ui: {
      ...
      trayChooseSkin: '🎨 Choose Skin…',
      skinSelectorTitle: 'Choose Skin',
      ...
      trayScreensaverOn: '💕 Disable CP Screensaver',
      trayScreensaverOff: '💕 Enable CP Screensaver',
      trayScreensaverThreshold: '💕 Screensaver Idle Time',
      trayWeatherSyncOn: '🌤️ Disable Weather Sync',
      trayWeatherSyncOff: '🌤️ Enable Weather Sync',
      trayWeatherSyncConfig: '🌤️ Set City',
      trayScreensaverPowerHint: 'Note: Windows screen-off/sleep must occur later than the selected wait time, or you may miss the animation.',
  ...
  ja: {
    ui: {
      ...
      trayChooseSkin: '🎨 装束を選ぶ…',
      skinSelectorTitle: '装束を選ぶ',
      ...
      trayScreensaverOn: '💕 屏保を無効化',
      trayScreensaverOff: '💕 屏保を有効化',
      trayScreensaverThreshold: '💕 屏保待機時間',
      trayWeatherSyncOn: '🌤️ 天気同期を無効化',
      trayWeatherSyncOff: '🌤️ 天気同期を有効化',
      trayWeatherSyncConfig: '🌤️ 都市設定',
      trayScreensaverPowerHint: 'ヒント：Windows の画面オフ・スリープ時間は選択した待機時間より後に設定してください。そうしないと演出が見えない場合があります。',
