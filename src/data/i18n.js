...
const I18N = {
  ...
  zh: {
    ui: {
      ...
      trayPomodoroOpen: '🍅 打开番茄钟',
      trayPomodoroRunning: '🍅 专注中',
      trayPomodoroCompleted: '🍅 专注完成',
      ...
      pomodoroUnpin: '取消置顶',
      pomodoroClose: '关闭',
      pomodoroPrompt: '设定这次专注时间',
      pomodoroDecrease: '减少时间',
      pomodoroIncrease: '增加时间',
      pomodoroStart: '开始专注',
      pomodoroStop: '结束',
      pomodoroCompleted: '辛苦了',
      pomodoroCompleteMessage: '做得很好，先把这一口气慢慢放下。',
      pomodoroFinish: '完成',
      pomodoroLastHint: '默认使用上次的分钟数',
  ...
  en: {
    ui: {
      ...
      trayPomodoroOpen: '🍅 Open Pomodoro',
      trayPomodoroRunning: '🍅 Focusing',
      trayPomodoroCompleted: '🍅 Focus Complete',
      ...
      pomodoroPin: 'Keep on top',
      pomodoroUnpin: 'Stop keeping on top',
      pomodoroClose: 'Close',
      pomodoroPrompt: 'Set this focus time',
      pomodoroDecrease: 'Decrease time',
      pomodoroIncrease: 'Increase time',
      pomodoroStart: 'Start focus',
      pomodoroStop: 'Stop',
      pomodoroCompleted: 'Well done',
      pomodoroCompleteMessage: 'You did well. Let this breath settle before the next thing.',
      pomodoroFinish: 'Done',
      pomodoroLastHint: 'Defaults to the last minutes you used',
  ...
  ja: {
    ui: {
      ...
      trayPomodoroOpen: '🍅 集中時計を開く',
      trayPomodoroRunning: '🍅 集中中',
      trayPomodoroCompleted: '🍅 集中完了',
      ...
      pomodoroTitle: '集中時計',
      pomodoroPin: '最前面に固定',
      pomodoroUnpin: '最前面固定を解除',
      pomodoroClose: '閉じる',
      pomodoroPrompt: '今回の集中時間',
      pomodoroDecrease: '時間を減らす',
      pomodoroIncrease: '時間を増やす',
      pomodoroStart: '集中を始める',
      pomodoroStop: '終了',
      pomodoroCompleted: 'おつかれさま',
      pomodoroCompleteMessage: 'よくできました。次へ行く前に、ひと息置きましょう。',
      pomodoroFinish: '完了',
      pomodoroLastHint: '前回使った分数を初期値にします',
